...
```
### Activity:
Create a new object called 'inverts_moyr' starting frim inverts_long that unites teh month and year columns into a single column named "mo_yr", using a slash"/" as the separator....then try some other fun separator
...
Example:  In the common_name column, you want to replace spiny with the word "awesome"

```{r}
awesome_lobsta <- inverts %>% 
  mutate(common_name = 
           str_replace(common_name, 
                       pattern = "spiny",
                       replacement = "awesome"))
